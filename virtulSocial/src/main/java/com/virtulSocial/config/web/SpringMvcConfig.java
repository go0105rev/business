package com.virtulSocial.config.web;
 ...
 * Configure SpringMVC.
 */
@ComponentScan(basePackages = { "com.virtulSocial.app" })
...
public class SpringMvcConfig implements WebMvcConfigurer {
     ...
     * @see com.virtulSocial.config.app.ApplicationContext#exceptionCodeResolver()
     ...
     * @see com.virtulSocial.config.app.ApplicationContext#exceptionLogger()
