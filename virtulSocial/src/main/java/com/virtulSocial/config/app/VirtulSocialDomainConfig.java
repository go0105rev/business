package com.virtulSocial.config.app;
...
@ComponentScan(basePackages = { "com.virtulSocial.domain" })
@Import({ VirtulSocialInfraConfig.class,
    VirtulSocialCodeListConfig.class })
public class VirtulSocialDomainConfig {
     ...
     * @see com.virtulSocial.config.app.ApplicationContextConfig#exceptionLogger()
