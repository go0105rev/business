 ...
 */
@Configuration
@EnableJpaRepositories("com.virtulSocial.domain.repository")
@Import({ VirtulSocialEnvConfig.class })
public class VirtulSocialInfraConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        bean.setPackagesToScan("com.virtulSocial.domain.model");
