...
import elearnBatch.config.JobBaseContextConfig;
import elearnBatch.job01.Employee;
import elearnBatch.job01.EmployeeProcessor;

@Configuration
@Import(JobBaseContextConfig.class)
@ComponentScan("elearnBatch.job01")
@MapperScan(basePackages = "elearnBatch.job01", sqlSessionFactoryRef = "jobSqlSessionFactory")
