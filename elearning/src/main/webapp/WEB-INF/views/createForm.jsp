                ...
                <div class="title-container text-center">
                    ...
                    <div class="login">
                        ...
                        <form:form action="${pageContext.request.contextPath}/login/userInf/confirm" method="get" modelAttribute="userForm">
                            ...
                            性別<br><form:select path="gender"><form:option value="1">男性</form:option><form:option value="2">女性</form:option><form:option value="3">その他</form:option></form:select><br><br>
                            年齢<form:input path="age"/>
                            職歴年数<form:input path="exp"/>
