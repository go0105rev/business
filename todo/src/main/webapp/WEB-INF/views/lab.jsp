...
<body>
    ...
    -->
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="https://www.revale.co.jp/" class="simple-text">
                        Code eLearning
                    </a>
                </div>
                <ul class="nav">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <h1>A:四角問題</h1>
                    <p>aaaaaaaaaaaaaaaaaaaaaaaaaa<br/>aaaaaaaaaaaaaaa。</p>
                    <div class="UnitTest">
                        <t:messagesPanel/>
                        <form:form
                            action="${pageContext.request.contextPath}/codeLearn/lab/commit"
                            method="post" modelAttribute="unitTestInput">
                            <form:errors class="alert-error" path="context" />
                            <form:input type="hidden" path="scope" value="2"/>
                            <form:input type="hidden" path="ques" value="1"/>
                    ...
                    <h4>ソースID</h4>
                        <ul>
                            <c:forEach items="${unitTests}" var="unit">
                                <li>
                                    ${f:h(unit.sourceNum)}
                                    ${f:h(unit.saveTime)}
                                </li>
